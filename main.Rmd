...
conf_filtered <- build_data(START_CASES_NO = 1, MIN_CASES = 2000, MAX_CASES = Inf, CHART_MAX = Inf, countries_include)
...
ggplot(conf_filtered, aes(days, log(value), colour = country)) + 
  ...
  labs(title = "1.1 Log(Number of cases), Day 0 = 1 case", subtitle = "countries > 2000 + Poland") +
...
```{r, echo=FALSE, error=FALSE, warning=FALSE, message=FALSE}
countries_include <- c("Poland")
conf_filtered <- build_data(START_CASES_NO = 30, MIN_CASES = 2000, MAX_CASES = Inf, CHART_MAX = Inf, countries_include)
...
ggplot(conf_filtered, aes(days, log(value), colour = country)) + 
  ...
  geom_text(data = conf_filtered %>% filter(maxv == 1), aes(label = country, colour = country, x = days, y = log(value)), hjust = -.1, size = 3) +
  labs(y="Log(Number of cases)", x = "Days from patient 0") +
  labs(title = "1.2 Log(Number of cases), Day 0 = 30 cases", subtitle = "countries > 2000 + Poland") +
  labs(caption = "data source: github.com/CSSEGISandData/COVID-19") +
  theme(legend.position="none")
```
...
```{r, echo=FALSE, error=FALSE, warning=FALSE, message=FALSE}
countries_include <- c("Poland")
conf_filtered <- build_data(START_CASES_NO = 1, MIN_CASES = 2000, MAX_CASES = Inf, CHART_MAX = 40000, countries_include)
...
ggplot(conf_filtered, aes(days, value, colour = country)) + 
  ...
  labs(title = "2.1 Number of cases, Day 0 = 1 case", subtitle = "countries > 2000 + Poland, crop at 40000") +
  labs(caption = "data source: github.com/CSSEGISandData/COVID-19") +
  theme(legend.position="none")
```
...
```{r, echo=FALSE, error=FALSE, warning=FALSE, message=FALSE}
countries_include <- c("Poland")
conf_filtered <- build_data(START_CASES_NO = 30, MIN_CASES = 2000, MAX_CASES = Inf, CHART_MAX = 40000, countries_include)
...
ggplot(conf_filtered, aes(days, value, colour = country)) + 
  ...
  geom_text(data = conf_filtered %>% filter(maxv == 1), aes(label = country, colour = country, x = days, y = value), hjust = -.1, size = 3) +
  labs(y="Number of cases", x = "Days from patient 0") +
  labs(title = "2.2 Number of cases, Day 0 = 30 cases", subtitle = "countries > 2000 + Poland, crop at 40000") +
  labs(caption = "data source: github.com/CSSEGISandData/COVID-19") +
  theme(legend.position="none")
```
...
ggplot(conf_filtered, aes(days, value_per_1M, colour = country)) + 
  ...
  labs(title = "3.1 Number of cases per 1M inhabitans, Day 0 = 1 case", subtitle = "countries > 2000 nominal cases + Poland") +
  labs(caption = "data source: github.com/CSSEGISandData/COVID-19") +
  theme(legend.position="none")
```
...
ggplot(conf_filtered, aes(days, value_per_1M, colour = country)) + 
  ...
  geom_text(data = conf_filtered %>% filter(maxv == 1), aes(label = country, colour = country, x = days, y = value_per_1M), hjust = -.1, size = 3) +
  labs(y="Number of cases per 1M inhabitants", x = "Days from patient 0") +
  labs(title = "3.2 Number of cases per 1M inhabitans, Day 0 = 30 cases", subtitle = "countries > 2000 nominal cases + Poland") +
  labs(caption = "data source: github.com/CSSEGISandData/COVID-19") +
  theme(legend.position="none")
```
...
ggplot(conf_filtered, aes(pop_density, value_per_1M, colour = country)) + 
  ...
  labs(title = "4.1 Number of cases per 1M inhabitans vs pop density", subtitle = "countries > 1000 nominal cases + Poland") +
  labs(caption = "data source: github.com/CSSEGISandData/COVID-19") +
  theme(legend.position="none")
```

Hipoteza: im większa gęstość zaludnienia, tym szybciej powinien krążyć wirus.
...
ggplot(conf_filtered, aes(tests_per_1M, cases_per_test, colour = country)) + 
  ...
  labs(title = "5.1 Number of tests per 1M inhabitants vs cases per test, cumulative", subtitle = "countries > 2000 nominal cases + Poland. Point label = date") +
...
ggplot(conf_filtered, aes(tests_per_1M_new, cases_per_test_new, colour = country)) + 
  ...
  labs(title = "5.2 Log Number of new tests per 1M inhabitants vs log new cases per 1 new test", subtitle = "countries > 2000 nominal cases + Poland. Point label = date") +
  labs(caption = "source: github.com/CSSEGISandData/COVID-19, finddx.org/covid-19/test-tracker") +
  theme(legend.position = "none")
```
...
countries_include = c("Poland","Austria","Belgium","Denmark","France","Germany","Iran","Italy","Korea, South","Netherlands","Norway","Spain","Sweden","Switzerland","US","United Kingdom")
  ...
  ggplot(      data = data_chart,                       aes(x = date, colour = country ) ) + 
    ...
    labs(title = "6.1 Number of cases in 3 days forecast", subtitle = "countries > 1000 + Poland") +
    labs(caption = "data source: github.com/CSSEGISandData/COVID-19") +
    theme(legend.position="none")
```
